...
/**
 * Test that the fallback {@code DatabricksBufferAllocator} is used with an unknown allocation
 ...
 */
public class ArrowBufferAllocatorUnknownManagerTest {
  private static final Logger logger =
      LoggerFactory.getLogger(ArrowBufferAllocatorUnknownManagerTest.class);
  ...
  static void setUpAllocationManagerType() {
    ...
    System.setProperty(ARROW_ALLOCATION_MANAGER_TYPE, "Unknown");
    logger.info("Setting system property {} to Unknown", ARROW_ALLOCATION_MANAGER_TYPE);
  }

  @Test
  @Tag("Jvm17PlusAndArrowToNioReflectionDisabled")
  @EnabledOnJre({JRE.JAVA_17, JRE.JAVA_21})
  public void testCreateDatabricksBufferAllocatorWithUnknownManagerType() throws IOException {
