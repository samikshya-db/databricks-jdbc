...
public enum DatabricksDriverErrorCode {
  ...
  CURSOR_INVALID_POSITION(1045),
  COLUMN_INDEX_OUT_OF_BOUNDS(1046),
  ROW_INDEX_OUT_OF_BOUNDS(1047),
  THRIFT_RPC_ERROR(1048),
  THRIFT_RESPONSE_MISMATCH(1049),
  INVALID_RESPONSE_FORMAT(1050),
  THREAD_POOL_EXECUTION_ERROR(1051),
  STREAM_READ_ERROR(1052),
